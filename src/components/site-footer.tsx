    ...
    <footer className="site-footer">
      <div className="footer-main">
        <div className="footer-brand">
          <Link href="/catalogo" aria-label="Mesa & Graça">
            <BrandLogo />
          </Link>
          <p>Peças autorais para mesas que recebem com beleza e afeto.</p>
        </div>
        <div className="footer-catalog">
          <span>Catálogo</span>
          <Link href="/catalogo">Todos os produtos</Link>
          <Link href="/catalogo">Lugar americano</Link>
          <Link href="/catalogo">Porta-guardanapos</Link>
        </div>
        <div className="footer-contact">
          <span>Atendimento para atacado</span>
          <strong>
            Monte seu pedido
            <br />
            com a nossa equipe.
